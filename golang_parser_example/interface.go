...
// aparently golang already has a way to parse just a string hahahaha
// but i really wanna make just a parser for function signatures so
// i might return to this thing later down the line, because using
// the entire golang parser for that is kind an overkill
func ParseRawString(x string) (ast.Expr, error) {
